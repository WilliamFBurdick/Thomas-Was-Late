...
Engine::Engine()
{
	...
	//initialize the main (non-splitscreen) view
	...
	//can this graphics card handle shaders?  If not, quit
	if (!sf::Shader::isAvailable()) m_Window.close();
	else m_RippleShader.loadFromFile("shaders/vertShader.vert", "shaders/rippleShader.frag");
